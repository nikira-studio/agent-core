...
Do not publish vulnerability details, working exploits, real credentials, backup files, database files, `credential.key`, or `broker.credential` in public issues.
...
- Normal credential, MCP, dashboard, audit, and metadata export responses do not include raw credential values.
